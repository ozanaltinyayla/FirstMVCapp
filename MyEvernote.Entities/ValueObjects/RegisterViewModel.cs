...
namespace MyEvernote.Entities.ValueObjects
{
    public class RegisterViewModel
    {
        ...
        [DisplayName("E-Mail"), Required(ErrorMessage = "{0} alanı boş geçilemez"), StringLength(70, ErrorMessage = "{0} max. {1} karakter olmalıdır"),EmailAddress(ErrorMessage ="Lütfen {0} alanı için geçerli bir E-mail adresi giriniz")]
